...
class Ui_MainWindow(object):
    ...
    def retranslateMainUi(self, MainWindow):
        ...
        for item in cursor:
            ...
            for value in item:
                ...
                self.gridLayout.addWidget(but_item, j, 12, 1, 1)
    ...
    def setuptripUi(self):
        ...
        self.label_4.setObjectName("destlabel")
        ...
        self.label_3.setObjectName("fromlabel")
        ...
        self.label_6.setObjectName("transportlabel")
